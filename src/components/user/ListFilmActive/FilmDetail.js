    ...
    return (
        <>        
            ...
            <Grid container spacing={4}>
                ...
                <CardMedia width={300} height={250}
                        component="img"
                        image={filmDetails.posterUrl || "https://via.placeholder.com/200x300"}
                        alt={filmDetails.title}
                        sx={{ borderRadius: 2 }}
                    />
                    </Grid>
                    <Grid item xs={12} md={8}>
                    <Typography variant="h4" gutterBottom>{filmDetails.title}</Typography>
                    <Typography variant='h5' gutterBottom>Rating: {avarageRatings}</Typography>
                    <Typography variant="body1" gutterBottom>
                        <div dangerouslySetInnerHTML={{ __html: filmDetails.description }} />
                    </Typography>
                    
                    <Typography variant="body2" color="textSecondary" gutterBottom>
                        <strong>Genre:</strong> {filmDetails.genre}
                    </Typography>
                    <Typography variant="body2" color="textSecondary" gutterBottom>
                        <strong>Director:</strong> {filmDetails.director}
                    </Typography>
                    <Typography variant="body2" color="textSecondary" gutterBottom>
                        <strong>Cast:</strong> ABC
                    </Typography>
                    <Typography variant="body2" color="textSecondary" gutterBottom>
