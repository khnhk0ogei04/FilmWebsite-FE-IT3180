...
export const BookingPage = () => {
    ...
    return (
        <Box sx={{ p: 4 }}>
            ...
            <Typography variant="h6">Rạp: {scheduleDetails.cinemaName}</Typography>
            <Typography variant="h6">Suất chiếu: {scheduleDetails.shiftName} ({scheduleDetails.shiftStart} - {scheduleDetails.shiftEnd})</Typography>
            <Typography variant="h6">Ngày chiếu: {scheduleDetails.scheduleDate}</Typography>
